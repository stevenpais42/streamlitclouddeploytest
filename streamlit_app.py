...
st.write('Understanding species count in the data set')
sp_count = df.Species.value_counts(dropna=False)
st.write(sp_count)
st.write('Understanding species distribution in the data set')
sp_pct = df.Species.value_counts(dropna=False, normalize=True)
st.write(sp_pct)
